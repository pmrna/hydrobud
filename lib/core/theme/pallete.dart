...
class AppPallete {
  ...
  static const Color borderColor = Color(0xFFA4C037);
...
class WidgetPallete {
  static const Color greenStroke = Color(0xFF86A900);
  static const Color yellowstroke = Color(0xFFC89F0E);
  static const Color pinkStroke = Color(0xFFB5006C);
  static const Color blueStroke = Color(0xFF302CC5);
  static const Color greenAccent = Color(0xFFAEC74F);
  ...
  static const Color graphContainerColor = Color(0xFFD1DEA3); //stops 0%
}
